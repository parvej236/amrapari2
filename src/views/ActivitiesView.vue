...
const categories = computed(() => [
  {
    ...
    description: t.ictDesc || 'We excel in empowering individuals with advanced digital skills and innovative thinking to thrive in the modern technological era. Our vision is to lead the world through excellence in technology—cultivating skilled professionals who drive progress in programming, design, artificial intelligence, and emerging digital fields. With a focus on creativity, problem-solving, and real-world application, we aim to shape the next generation of global tech leaders.',
  ...
  },
  {
    ...
    description: t.scienceDesc || 'We foster a spirit of curiosity, discovery, and innovation through the power of science. Our goal is to cultivate analytical minds that explore, experiment, and push the boundaries of human knowledge. From understanding the laws of nature to advancing robotics and life sciences, we inspire learners to question, create, and contribute to scientific progress that shapes a better, smarter world',
  ...
  },
  {
    ...
    description: t.creativityDesc || 'We celebrate creativity and cultural expression as vital forces that connect people and inspire innovation. Through art, music, dance, and intellectual pursuits, we nurture imagination, confidence, and collaboration. Our cultural activities encourage students to express their individuality, embrace diversity, and develop a well-rounded character that blends talent, emotion, and intellect in harmony.',
  ...
  },
  {
    ...
    description: t.sportsDesc || 'We believe in the power of sports to build discipline, teamwork, and resilience. Through a wide range of athletic and recreational activities, we encourage students to embrace a spirit of competition, fitness, and fair play. Our sports programs develop physical strength, mental endurance, and leadership qualities—preparing individuals to excel both on and off the field.',
  ...
  },
  {
    ...
    description: t.bandDesc || 'Our band represents the rhythm of unity, passion, and creativity. Through music, we cultivate harmony, discipline, and expression among our members. From powerful drumbeats to soulful melodies, the band brings our community together, showcasing talent, teamwork, and the inspiring spirit of performance.',
