...
const categories = computed(() => [
  {
    ...
    items: t.ictItems || ['Computer Basics', 'Python Programming', 'Web Development'],
  ...
  },
  {
    ...
    items: t.scienceItems || ['Physics Experiments', 'Chemistry Lab', 'Biology'],
  ...
  },
  {
    ...
    items: t.creativityItems || ['Painting', 'Crafts', 'Design'],
  ...
  },
  {
    ...
    items: t.sportsItems || ['Football', 'Cricket', 'Athletics'],
    gradient: 'from-green-500 to-emerald-500',
    illustration: Dumbbell,
    subItems: {
      title: language.value === 'bn' ? 'অ্যাথলেটিক্স বিভাগ' : 'Athletics Events',
      items: t.athleticsItems || ['100m Sprint', 'Long Jump', 'High Jump'],
    },
  },
  {
    id: 'band',
    ...
    items: t.bandItems || ['Drums', 'Guitar', 'Vocals'],
